...
// Entry
$_['entry_enabled']                      = 'Enable Affirm';
$_['entry_payment_action_authorize']     = 'Authorize only';
$_['entry_payment_action_charge']        = 'Authorize + Capture';

// Placeholder
$_['placeholder_affirm_title'] = 'Pay with Affirm';

// Error
$_['error_permission']      = 'Warning: You do not have permission to modify payment Affirm!';
$_['error_settings_affirm'] = 'Warning: Your Affirm settings were not saved!';

// Success
$_['success_settings_affirm'] = 'Your Affirm settings were saved!';
