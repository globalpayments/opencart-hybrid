<?php
// Heading
$_['heading_title'] = 'GlobalPayments - 整合支付';
...
$_['text_edit']               = '編輯 GlobalPayments - 整合支付';
...
$_['label_enable_three_d_secure'] = '啟用 3DSecure';
$_['label_integration_type']      = '整合類型';
$_['label_sort_order']            = '排序順序';
$_['label_blik']                  = '啟用 Blik 付款';
$_['label_open_banking']          = '啟用開放銀行付款';
...
$_['help_account_name']          = '指定處理交易時使用的帳戶。如未指定，將使用預設帳戶。<br>如需協助找到您的帳戶名稱，請根據您的地區聯絡我們的<a href="https://developer.globalpay.com/support/integration-support" target="_blank">整合支援</a>團隊';
$_['help_integration_type']      = '選擇您的付款表單是顯示在結帳頁面上還是重新導向到託管頁面（託管方式可簡化 Apple 和 Google Pay 的啟用）。';
...
$_['entry_integration_type_hosted_payment'] = '託管付款頁面';
...
$_['error_live_credentials_account_name'] = '請提供正式環境帳戶名稱。';
$_['error_sandbox_credentials_app_id']  = '請提供沙盒環境憑證。';
$_['error_sandbox_credentials_app_key'] = '請提供沙盒環境憑證。';
$_['error_sandbox_credentials_account_name'] = '請提供沙盒環境帳戶名稱。';
...
$_['text_refunded_comment']                  = '訂單已完全退款。';
