...
// Entry
$_['entry_enabled']                      = '啟用 Affirm';
$_['entry_payment_action_authorize']     = '僅授權';
$_['entry_payment_action_charge']        = '授權 + 擷取';

// Placeholder
$_['placeholder_affirm_title'] = '使用 Affirm 付款';

// Error
$_['error_permission']      = '警告：您沒有權限修改 Affirm 付款設定！';
$_['error_settings_affirm'] = '警告：您的 Affirm 設定未儲存！';

// Success
$_['success_settings_affirm'] = '您的 Affirm 設定已儲存！';
