...
// Entry
$_['entry_enabled']                      = '"Habilitar Affirm';
$_['entry_payment_action_authorize']     = 'Autorizar sólo';
$_['entry_payment_action_charge']        = '"Autorizar + Captura';

// Placeholder
$_['placeholder_affirm_title'] = 'Pagar con Affirm';

// Error
$_['error_permission']      = '"Advertencia: No tienes permiso para modificar el pago Affirm';
$_['error_settings_affirm'] = 'Advertencia: ¡Su configuración de Affirm no se guardó!';

// Success
$_['success_settings_affirm'] = '"¡Se guardaron tus configuraciones de Affirm!';
