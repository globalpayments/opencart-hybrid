...
class ControllerExtensionPaymentGlobalPaymentsClearpay extends Controller {
	...
	public function display($error) {
		...
		if (isset($this->request->post['payment_globalpayments_clearpay_sort_order'])) {
			$data['payment_globalpayments_clearpay_sort_order'] = $this->request->post['payment_globalpayments_clearpay_sort_order'];
		} else {
			$data['payment_globalpayments_clearpay_sort_order'] = $this->config->get('payment_globalpayments_clearpay_sort_order') ?? 0;
		}
