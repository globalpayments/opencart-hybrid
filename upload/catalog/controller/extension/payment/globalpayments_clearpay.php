...
class ControllerExtensionPaymentGlobalPaymentsClearpay extends Controller {
	public function __construct( $registry ) {
		...
		$this->globalpayments->setPaymentMethod(Clearpay::PAYMENT_METHOD_ID);
	}
	...
	public function index() {
		...
		$data['action'] = $this->url->link('extension/payment/globalpayments_clearpay/confirm', '', true);
		...
		$data['globalpayments_clearpay_params'] = $this->globalpayments->paymentMethod->paymentFieldsParams();
		$data['globalpayments_order'] = json_encode($this->order);
		$data['globalpayments_clearpay_is_allowed'] =
			json_encode($this->globalpayments->paymentMethod->checkIfPaymentAllowed($this->order));
		$data['globalpayments_clearpay_validCustomerDetails'] =
