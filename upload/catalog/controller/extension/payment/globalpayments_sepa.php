...
class ControllerExtensionPaymentGlobalPaymentsSepa extends Controller {
	public function __construct( $registry ) {
		...
		$this->globalpayments->setPaymentMethod(Sepa::PAYMENT_METHOD_ID);
	}
	...
	public function index() {
		...
		$data['action'] = $this->url->link('extension/payment/globalpayments_sepa/confirm', '', true);
		...
		$data['globalpayments_sepa_is_allowed'] =
	...
	public function confirm() {
		...
		try {
			...
			$requestData->openBanking	    = (object)[
				...
				'iban' => $this->config->get('payment_globalpayments_sepa_iban'),
				'accountName' => $this->config->get('payment_globalpayments_sepa_account_name'),
			];
